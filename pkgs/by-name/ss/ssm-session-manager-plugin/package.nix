...
buildGoModule rec {
  ...
  patches = [
    ...
    (fetchpatch {
      url = "https://github.com/aws/session-manager-plugin/commit/e246c4f87c1af78be5f5a76f79bd66c27d63918f.patch";
      hash = "sha256-9Sm0O00rtbgEvHm3h35e9PnhMQPa+rFc+Fi/rrfi4CI=";
    })
  ];
